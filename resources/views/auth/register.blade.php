    ...
    <form method="POST" action="{{ route('register.post') }}">
        ...
        <div class="form-group">
            <div class="input-wrapper" style="{{ $errors->has('name') ? 'border-color: red;' : '' }}">
                ...
                <input type="text" name="name" value="{{ old('name') }}" class="input-field" placeholder="الأسم كامل" required>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="input-wrapper" style="{{ $errors->has('national_id') ? 'border-color: red;' : '' }}">
                ...
                <input type="text" name="national_id" value="{{ old('national_id') }}" minlength="14" maxlength="14" class="input-field" placeholder="الرقم القومي" required>
            </div>
        </div>

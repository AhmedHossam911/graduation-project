...
<body class="bg-[url('{{ asset('IMGs/HU%20IMG.png') }}')] bg-cover bg-center bg-no-repeat bg-fixed min-h-screen flex justify-center items-center relative overflow-hidden font-['Cairo']">
    ...
    <div class="bg-white/90 backdrop-blur-md rounded-2xl py-5 px-5 md:px-14 w-[95%] sm:w-[90%] md:w-full @yield('card-width', 'max-w-[568px]') mx-auto shadow-[0_10px_40px_rgba(0,0,0,0.1)] text-center">

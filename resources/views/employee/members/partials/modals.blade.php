...
<form action="{{ route('members.suspend', $member->id) }}" method="POST" enctype="multipart/form-data">
 ...
 <input type="file" required name="suspension_file" id="suspension-file" class="hidden" accept=".pdf, image/*">
 </label>
 </div>
...
<form action="{{ route('loans.start', $memberLoans->first()->id ?? 0) }}" method="POST"
 ...
 <iconify-icon icon="mingcute:upload-3-fill" class="text-2xl"></iconify-icon>
 <input type="file" id="file-21" name="check_image" class="hidden" accept=".pdf, image/*">
 </label>
 </div>
 <div class="border border-[#124375] rounded-[12px] ">
 <label for="file-22"
 ...
 <iconify-icon icon="mingcute:upload-3-fill" class="text-2xl"></iconify-icon>
 <input type="file" id="file-22" name="board_approval_image" class="hidden" accept=".pdf, image/*">
 </label>
 </div>
 </div>
 </div>
...
<form action="{{ route('loans.installments.pay', 0) }}" method="POST" enctype="multipart/form-data"
 ...
 <iconify-icon icon="mingcute:upload-3-fill" class="text-2xl"></iconify-icon>
 <input type="file" id="file-23" name="receipt_image" class="hidden" accept=".pdf, image/*">
 </label>
 </div>
 </div>
 </div>
...
<form action="{{ route('loans.earlyRepayment', $memberLoans->first()->id ?? 0) }}" method="POST"
 ...
 <p>اضغط لإرفاق صورة إيصال السداد</p>
 <iconify-icon icon="mingcute:upload-3-fill" class="text-2xl"></iconify-icon>
 <input type="file" id="file-24" name="receipt_image" class="hidden" accept=".pdf, image/*">
 </label>
 </div>
 </div>
 </div>
...
<form action="{{ route('subscriptions.pay', 0) }}" method="POST" enctype="multipart/form-data"
 ...
 <p>اضغط لإرفاق صورة إيصال السداد</p>
 <iconify-icon icon="mingcute:upload-3-fill" class="text-2xl"></iconify-icon>
 <input type="file" id="file-25" name="receipt_image" class="hidden" accept=".pdf, image/*">
 </label>
 </div>
 </div>
 </div>

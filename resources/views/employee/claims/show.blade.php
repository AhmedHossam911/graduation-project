...
@section('content')
    ...
    <form method="POST" action="{{ route('claims.approve', $claim->id) }}" enctype="multipart/form-data">
        @csrf
        <div
            class="modal hidden max-w-5xl mx-auto absolute top-0 left-1/2 -translate-x-1/2 z-[70] rounded-2xl bg-[#F4F7F9] navy-shadow pt-2 pb-10">
            <button
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="border border-[#124375] rounded-[12px] ">
                            <label for="file-1"
                                ...
                                <p>اضغط لإرفاق صورة من الموافقة والتوقيع الأول والثاني<span class="text-[#D92D20]">*</span></p>
                                <iconify-icon icon="mingcute:upload-3-fill" class="text-2xl"></iconify-icon>
                                <input type="file" name="receipt_file" id="file-1" required class="hidden"
                                    accept=".pdf, image/*">
                            </label>
                        </div>
                        <div class="border border-[#124375] rounded-[12px] ">
                            <label for="file-2"
                                class=" cursor-pointer py-9 text-[#124375] flex items-center justify-center gap-1">
                                <p>اضغط لإرفاق صورة من شيك الصرف <span class="text-[#D92D20]">*</span></p>
                                <iconify-icon icon="mingcute:upload-3-fill" class="text-2xl"></iconify-icon>
                                <input type="file" name="check_file" id="file-2" class="hidden" required
                                    accept=".pdf, image/*">
                            </label>
                        </div>
                    </div>

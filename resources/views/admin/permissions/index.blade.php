...
@section('content')
    ...
    <div class="flex justify-between items-center py-7 px-3">
    ...
    <div class="px-3">
        <div class="grid grid-cols-2 gap-3 items-center navy-shadow rounded-[16px] py-5 px-3">
            ...
            <div class="flex gap-2 w-full">
                <div class="bg-[#EAF5FF] py-2 px-1 rounded-[10px] w-full text-center">
                    <p class="text-[#124375]">إجمالي الحسابات :<span>{{ $activeUsers->total() }}</span></p>
                </div>
                <div class="bg-[#EFEFEF] py-2 px-1 rounded-[10px] w-full text-center">
                    <p class="text-[#021219]">حسابات موقوفة :<span>{{ $suspendedUsers->total() }}</span></p>
                </div>
                <div class="bg-[#FFF7ED] py-2 px-1 rounded-[10px] w-full text-center">
    ...
    <div class="tabs mx-12  pt-7 flex gap-8 border-b border-[#A8A8A8]">
        <div class="tab-item active px-7 flex gap-2 items-center relative hover:text-[#019168] transition-colors cursor-pointer green-active"
                    ...
                    <div class="bg-white rounded-[14px] border border-[#6D6D6D] p-4 flex flex-col gap-3 shadow-sm">
                        ...
                        <div class="flex flex-col gap-2 text-sm text-[#021219]">
                            ...
                            <div class="flex gap-2 items-center">
                                ...
                                <span
                                    class="text-[#019168] bg-[#F0FFF6] border border-[#019168] rounded-[8px] py-[1px] px-2">
                            ...
                            <div class="flex gap-2 flex-wrap mt-1">
                                @if ($user->custom_permissions && is_array($user->custom_permissions) && count($user->custom_permissions) > 0)
                                    <span
                                        class="text-[#16A34A] bg-[#DCFCE7] border border-[#16A34A] rounded-[8px] py-[1px] px-2 text-xs">{{ $user->custom_permissions[0] }}</span>
                                    @if (count($user->custom_permissions) > 1)
                                        <span

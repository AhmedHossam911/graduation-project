...
@section('content')
    ...
    <link(rel="stylesheet" href="{{ asset('css/departments.css') }}")>
        ...
        <div class="px-12">
            <div class="grid grid-cols-6 gap-10 items-center navy-shadow rounded-[16px] py-5 px-3">
                ...
                <div class="bg-[#EAF5FF] text-center py-2 px-3 rounded-[10px] col-span-1 tab-content"
                    ...
                    <p class="text-[#124375]">إجمالي الجهات :<span>3</span></p>
                </div>
                <div class="bg-[#FFEAE8] hidden text-center py-2 px-3 rounded-[10px] col-span-1 tab-content"
                    data-tab="الأرشيف">
                    <p class="text-[#D92D20]">إجمالي الجهات :<span>3</span></p>
                </div>
                ...
                <table class="w-full border-collapse">
                    ...
                    <tbody>
                        <tr class="text-center border-b border-[#6D6D6D]">
                            <td class="py-3 border-l border-[#6D6D6D] text-[#021219] font-medium">كلية تجارة وإدارة أعمال
                            </td>
                            <td class="py-3 border-l border-[#6D6D6D] text-[#021219] ">ENG-H</td>
                            <td class="py-3 border-l border-[#6D6D6D] text-[#021219]">1200 عضو</td>
                            ...
                            <td class="py-3 flex gap-7 items-center justify-center text-[#124375]">
                                <a href="../collegeMemberPage/collegeMembers.html">
                                    <iconify-icon icon="solar:eye-linear"
                                        class="text-2xl text-[#021219] cursor-pointer"></iconify-icon>
                                </a>
                                <iconify-icon icon="ic:round-edit" class="text-2xl text-[#124375] cursor-pointer open-modal"
                        ...
                        <tr class="text-center bg-[#EFEFEF]">
                            ...
                            <td class="py-3 flex gap-7 items-center justify-center text-[#124375]">
                                ...
                                <iconify-icon icon="ic:round-edit"
                                    class="text-2xl text-[#124375] cursor-pointer open-modal "
                                    data-modal="modal2"></iconify-icon>
                                <iconify-icon icon="zondicons:close-solid"
                                    class="text-xl text-[#D92D20] cursor-pointer "></iconify-icon>
                            </td>
                ...
                <div class="space-y-7">
                    <div class="flex flex-col gap-7">
                        <div class="relative w-full">
                            ...
                            <input type="text" placeholder="مثال : كلية الطب"
                        ...
                        <div class="relative w-full">
                            ...
                            <input type="text" placeholder="مثال : 200"
                                class="outline-none focus:ring-1 focus:ring-[#124375] focus:shadow-[#124375] focus:shadow transition py-3 w-full border border-[#124375] bg-[#F4F7F9] rounded-xl text-center ">
                        </div>
                    </div>
                </div>

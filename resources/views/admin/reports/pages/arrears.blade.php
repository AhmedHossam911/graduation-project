...
@section('content')
    <div class="flex justify-between px-12 py-5 print:hidden">
        <div>
            ...
            <p class="text-[#6D6D6D] text-[16px] font-normal mt-2">حصر الأعضاء المتأخرين عن سداد الاشتراكات الدورية وتحديد قيم المديونيات.</p>
        </div>
        <div class="btns flex items-center gap-3">
            ...
            <a href="{{ route('subscriptions.export', ['status' => 'unpaid', ...request()->query()]) }}"

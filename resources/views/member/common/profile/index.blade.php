    ...
    <section class="px-4 md:px-12 py-7">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 md:gap-0 bg-[#F4F7F9] navy-shadow rounded-[16px] py-5 px-4">
            ...
            <div class="w-full md:w-auto">
                <button
                    class="edit-btn hover:bg-[#0e3560] transition-colors flex justify-center items-center gap-3 bg-[#124375] text-[#F4F7F9] py-3 px-14 rounded-[12px] navy-shadow w-full md:w-auto">
        ...
        <form action="{{ route('profile.update') }}" method="POST" class="bg-[#F4F7F9] navy-shadow rounded-2xl space-y-20">
            ...
            <div class="px-5 pb-5 space-y-7">
                ...
                <div class="flex justify-center md:justify-end w-full">
                    <button type="submit"
                        class="save-btn hidden hover:bg-[#0e3560] transition-colors flex justify-center items-center gap-3 bg-[#124375] text-[#F4F7F9] py-3 px-14 rounded-[12px] navy-shadow w-full md:w-auto">

...
@section('content')
 ...
 @if (!in_array($membership->status, ['withdrawn', 'dismissed', 'suspended']) && !$membership->claims()->exists())
 ...
 <div
 class="rounded-[12px] bg-[#FFF7ED] max-w-xl orange-shadow py-7 px-12 mx-auto flex flex-col gap-7 justify-center items-center">
 <div>
 ...
 <div>
 <p class="text-[#6D6D6D] text-[14px] font-medium">وفقاً لحالة عضويتك الحالية، لا يمكنك تقديم طلب لصرف
 المستحقات.</p>
 </div>
 <div>
 <a href="{{ route('member.dashboard') }}"
 ...
 <div
 class="rounded-[12px] bg-[#FFF7ED] orange-shadow py-4 px-5 mx-4 w-1/2 mt-7 flex flex-col gap-7 justify-center items-center text-center">
 <div>
 <iconify-icon icon="material-symbols:info-rounded"
 class="text-4xl text-[#F79009] bg-[#FEF3C7] rounded-full py-4 px-4"></iconify-icon>
 </div>
 ...
 <div>
 <p class="text-[#6D6D6D] text-[14px] font-medium">لقد قمت بتقديم مطالبة مسبقاً، ولا يمكنك تقديم أكثر من
 طلب.
 </p>
 </div>
 <div>
 ...
 <div
 class="tabs grid grid-cols-2 md:grid-cols-6 gap-2 md:gap-0 bg-[#F4F7F9] navy-shadow rounded-[16px] px-4 py-5 ">
 ...
 <form action="{{ route('member.claims.store') }}" method="POST" enctype="multipart/form-data"
 class=" rounded-2xl border-2 border-[#124375] py-7 px-4 md:px-7 relative tab-content"
 data-tab="بلوغ سن التقاعد القانوني">
 @csrf
 <input type="hidden" name="claim_type" value="retirement">
 <h2
 class="absolute top-[-15px] right-2 md:right-5 px-2 text-[#124375] text-sm md:text-base font-medium bg-[#F4F7F9]">
 ...
 <div
 class="border border-[#124375] rounded-[12px] bg-[#F4F7F9] navy-shadow py-3 px-3 w-full sm:w-auto text-center">
 <label for="file_1"
 ...
 name="claim_documents[doc_1]" class="hidden" accept=".pdf, image/*">
 </label>
 </div>
 </div>
 <div
 ...
 name="claim_documents[doc_2]" class="hidden" accept=".pdf, image/*">
 </label>
 </div>
 </div>
 <div
 ...
 name="claim_documents[doc_3]" class="hidden" accept=".pdf, image/*">
 </label>
 </div>
 </div>
 <div
 ...
 name="claim_documents[doc_4]" class="hidden" accept=".pdf, image/*">
 </label>
 </div>
 </div>
 <div
 ...
 <div class="flex items-center gap-2">
 <iconify-icon icon="ion:document" class="text-2xl text-[#6D6D6D]"></iconify-icon>
 <p class="text-[16px] font-medium text-[#021219]">بيان بالمبالغ المخصومة من إدارة
 الاستحقاقات
 ...
 name="claim_documents[doc_5]" class="hidden" accept=".pdf, image/*">
 </label>
 </div>
 </div>
 </div>
 ...
 <p>أقر أنا العضو، بطلب صرف كافة مستحقاتي المالية المقررة من صندوق الزمالة، وذلك نظراً لانتهاء مدة
 الخدمة
 وبلوغ سن التقاعد القانوني. كما أقر بأن جميع البيانات والمستندات المرفقة صحيحة وتتوافق مع لائحة
 الصندوق.
 </p>
 </label>
 ...
 * تأكد من رفع جميع المستندات بصيغة واضحة (PDF أو صور).
 ...
 <form action="{{ route('member.claims.store') }}" method="POST" enctype="multipart/form-data"
 class="hidden rounded-2xl border-2 border-[#124375] py-7 px-4 md:px-7 relative tab-content"
 data-tab="النقل">
 @csrf
 ...
 name="claim_documents[doc_6]" class="hidden" accept=".pdf, image/*">
 </label>
 </div>
 </div>
 <div
 ...
 name="claim_documents[doc_7]" class="hidden" accept=".pdf, image/*">
 </label>
 </div>
 </div>
 <div
 ...
 <iconify-icon icon="mingcute:upload-3-fill" class="text-2xl"></iconify-icon>
 <p>إرفاق الملف</p>
 <input type="file" id="file_8"
 name="claim_documents[doc_8]" class="hidden" accept=".pdf, image/*">
 </label>
 </div>
 </div>
 <div
 ...
 <iconify-icon icon="mingcute:upload-3-fill" class="text-2xl"></iconify-icon>
 <p>إرفاق الملف</p>
 <input type="file" id="file_9"
 name="claim_documents[doc_9]" class="hidden" accept=".pdf, image/*">
 </label>
 </div>
 </div>
 <div
 ...
 <iconify-icon icon="mingcute:upload-3-fill" class="text-2xl"></iconify-icon>
 <p>إرفاق الملف</p>
 <input type="file" id="file_10"
 name="claim_documents[doc_10]" class="hidden" accept=".pdf, image/*">
 </label>
 </div>
 </div>
 </div>
 ...
 <p>أقر أنا العضو، بطلب تصفية وصرف كافة مستحقاتي المالية المقررة من صندوق الزمالة، وذلك بناءً على
 صدور
 قرار
 رسمي بنقلي خارج جهة العمل الحالية. كما أقر بأن جميع البيانات المرفقة وقرار إخلاء الطرف صحيحة
 وتتوافق
 مع
 ...
 * تأكد من رفع جميع المستندات بصيغة واضحة (PDF أو صور).
 ...
 <iconify-icon icon="mingcute:upload-3-fill" class="text-2xl"></iconify-icon>
 <p>إرفاق الملف</p>
 <input type="file" id="file_11"
 name="claim_documents[doc_11]" class="hidden" accept=".pdf, image/*">
 </label>
 </div>
 </div>
 <div
 ...
 <iconify-icon icon="mingcute:upload-3-fill" class="text-2xl"></iconify-icon>
 <p>إرفاق الملف</p>
 <input type="file" id="file_12"
 name="claim_documents[doc_12]" class="hidden" accept=".pdf, image/*">
 </label>
 </div>
 </div>
 <div
 ...
 <iconify-icon icon="mingcute:upload-3-fill" class="text-2xl"></iconify-icon>
 <p>إرفاق الملف</p>
 <input type="file" id="file_13"
 name="claim_documents[doc_13]" class="hidden" accept=".pdf, image/*">
 </label>
 </div>
 </div>
 <div
 ...
 <iconify-icon icon="mingcute:upload-3-fill" class="text-2xl"></iconify-icon>
 <p>إرفاق الملف</p>
 <input type="file" id="file_14"
 name="claim_documents[doc_14]" class="hidden" accept=".pdf, image/*">
 </label>
 </div>
 </div>
 <div
 ...
 <p>أقر أنا العضو، بطلب صرف كافة مستحقاتي المالية المقررة من صندوق الزمالة، وذلك نظراً لاستقالتي من
 جهة
 عملي
 ...
 * تأكد من رفع جميع المستندات بصيغة واضحة (PDF أو صور).
 ...
 <iconify-icon icon="mingcute:upload-3-fill" class="text-2xl"></iconify-icon>
 <p>إرفاق الملف</p>
 <input type="file" id="file_16"
 name="claim_documents[doc_16]" class="hidden" accept=".pdf, image/*">
 </label>
 </div>
 </div>
 <div
 ...
 <iconify-icon icon="mingcute:upload-3-fill" class="text-2xl"></iconify-icon>
 <p>إرفاق الملف</p>
 <input type="file" id="file_17"
 name="claim_documents[doc_17]" class="hidden" accept=".pdf, image/*">
 </label>
 </div>
 </div>
 <div
 ...
 <iconify-icon icon="mingcute:upload-3-fill" class="text-2xl"></iconify-icon>
 <p>إرفاق الملف</p>
 <input type="file" id="file_18"
 name="claim_documents[doc_18]" class="hidden" accept=".pdf, image/*">
 </label>
 </div>
 </div>
 <div
 ...
 <iconify-icon icon="mingcute:upload-3-fill" class="text-2xl"></iconify-icon>
 <p>إرفاق الملف</p>
 <input type="file" id="file_19"
 name="claim_documents[doc_19]" class="hidden" accept=".pdf, image/*">
 </label>
 </div>
 </div>
 <div
 ...
 <iconify-icon icon="mingcute:upload-3-fill" class="text-2xl"></iconify-icon>
 <p>إرفاق الملف</p>
 <input type="file" id="file_20"
 name="claim_documents[doc_20]" class="hidden" accept=".pdf, image/*">
 </label>
 </div>
 </div>
 </div>
 ...
 <p>أقر أنا العضو، بطلب صرف كافة مستحقاتي المالية المقررة من صندوق الزمالة، وذلك نظراً لانتهاء فترة
 عملي
 ...
 * تأكد من رفع جميع المستندات بصيغة واضحة (PDF أو صور).
 ...
 <iconify-icon icon="mingcute:upload-3-fill" class="text-2xl"></iconify-icon>
 <p>إرفاق الملف</p>
 <input type="file" id="file_21"
 name="claim_documents[doc_21]" class="hidden" accept=".pdf, image/*">
 </label>
 </div>
 </div>
 <div
 ...
 <iconify-icon icon="mingcute:upload-3-fill" class="text-2xl"></iconify-icon>
 <p>إرفاق الملف</p>
 <input type="file" id="file_22"
 name="claim_documents[doc_22]" class="hidden" accept=".pdf, image/*">
 </label>
 </div>
 </div>
 <div
 ...
 <iconify-icon icon="mingcute:upload-3-fill" class="text-2xl"></iconify-icon>
 <p>إرفاق الملف</p>
 <input type="file" id="file_23"
 name="claim_documents[doc_23]" class="hidden" accept=".pdf, image/*">
 </label>
 </div>
 </div>
 <div
 ...
 <iconify-icon icon="mingcute:upload-3-fill" class="text-2xl"></iconify-icon>
 <p>إرفاق الملف</p>
 <input type="file" id="file_24"
 name="claim_documents[doc_24]" class="hidden" accept=".pdf, image/*">
 </label>
 </div>
 </div>
 <div
 ...
 <p>أقر أنا العضو، بطلب صرف كافة مستحقاتي المالية المقررة من صندوق الزمالة، وذلك بناء علي صدور قرار
 رسمي
 ...
 * تأكد من رفع جميع المستندات بصيغة واضحة (PDF أو صور).
 ...
 <iconify-icon icon="mingcute:upload-3-fill" class="text-2xl"></iconify-icon>
 <p>إرفاق الملف</p>
 <input type="file" id="file_26"
 name="claim_documents[doc_26]" class="hidden" accept=".pdf, image/*">
 </label>
 </div>
 </div>
 <div
 ...
 <iconify-icon icon="mingcute:upload-3-fill" class="text-2xl"></iconify-icon>
 <p>إرفاق الملف</p>
 <input type="file" id="file_27"
 name="claim_documents[doc_27]" class="hidden" accept=".pdf, image/*">
 </label>
 </div>
 </div>
 <div
 ...
 <iconify-icon icon="mingcute:upload-3-fill" class="text-2xl"></iconify-icon>
 <p>إرفاق الملف</p>
 <input type="file" id="file_28"
 name="claim_documents[doc_28]" class="hidden" accept=".pdf, image/*">
 </label>
 </div>
 </div>
 <div
 ...
 <iconify-icon icon="mingcute:upload-3-fill" class="text-2xl"></iconify-icon>
 <p>إرفاق الملف</p>
 <input type="file" id="file_29"
 name="claim_documents[doc_29]" class="hidden" accept=".pdf, image/*">
 </label>
 </div>
 </div>
 <div
 ...
 الاستمرار في صندوق الزمالة. كما أقر بأن جميع البيانات والمستندات المرفقة صحيحة وتتوافق مع لائحة
 الصندوق.
 </p>
 </label>
 <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">

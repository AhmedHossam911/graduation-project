...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Passkey Management Middleware
    |--------------------------------------------------------------------------
    |
    | This middleware will be applied to the passkey management routes. By
    | default, we require password confirmation before a user can manage
    | their passkeys, but you may remove this if you do not want it.
    |
    */
